...
// mac1: 24:0A:C4:57:BE:F0 (mac do transmissor)

#define WIFI_CHANNEL 1
uint8_t peerMac[] = { 0x24, 0x0A, 0xC4, 0x57, 0xBE, 0xF0 }; // MAC do A
...
void setup() {
  ...
  Serial.println("B pronto. Enviando 'oi de B' a cada 2s...");
}

void loop() {
  const char* msg = "oi de B";
